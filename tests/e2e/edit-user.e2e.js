...
describe('Edit user Profile', function() {
  ...
  beforeEach(function() {
    element(by.repeater('item in ownerMenu').row(0)).click().then(
      function() {
        ...
        updateUserDataBtn = browser.findElement(by.id(
          'update-user-data'));
      });
  });
  ...
  it('Should not update user without username, full-name and city ',
    function() {
