...
describe('Test sign up page', function() {
  ...
  it('Should not create user with password that doesnt' +
    ' contain uppercase and lowercase alphabets', function() {
      email.sendKeys('heavywater@gmail.com');
  ...
  it('Should not allow user to use password less than 8 characters',
    function() {
      email.sendKeys('heavywater@gmail.com');
